...
CREATE TABLE Courses (
	...
	creditHours INT NOT NULL CHECK (
		creditHours <= 4
		AND creditHours > 0
	),
...
VALUES (101, 'CS', 'Computer Science'),
	(102, 'ENG', 'English'),
	(103, 'BIO', 'Biology'),
...
WHERE enrolledStudent = 9911
	AND enrolledInCourse = 316;
SELECT *
FROM Enrollment
WHERE enrolledStudent = 9911
	AND enrolledInCourse = 316;
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- OEL Extension part 2 for finals
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- Add GPA column
...
UPDATE Students
SET GPA = 3.8
WHERE student_ID = 9911;
UPDATE Students
SET GPA = 3.9
WHERE student_ID = 9912;
UPDATE Students
SET GPA = 3.7
WHERE student_ID = 9913;
UPDATE Students
SET GPA = 3.6
WHERE student_ID = 9914;
UPDATE Students
SET GPA = 3.5
WHERE student_ID = 9915;
UPDATE Students
SET GPA = 3.4
WHERE student_ID = 9916;
UPDATE Students
SET GPA = 3.3
WHERE student_ID = 9917;
UPDATE Students
SET GPA = 3.3
WHERE student_ID = 9918;
UPDATE Students
SET GPA = 3.2
WHERE student_ID = 9919;
UPDATE Students
SET GPA = 3.1
WHERE student_ID = 9920;
UPDATE Students
SET GPA = 3.0
WHERE student_ID = 9921;
UPDATE Students
SET GPA = 2.5
WHERE student_ID = 9922;
UPDATE Students
SET GPA = 2.6
WHERE student_ID = 9923;
UPDATE Students
SET GPA = 2.7
WHERE student_ID = 9924;
UPDATE Students
SET GPA = 2.8
WHERE student_ID = 9925;
UPDATE Students
SET GPA = 2.1
WHERE student_ID = 9926;
UPDATE Students
SET GPA = 2.2
WHERE student_ID = 9927;
UPDATE Students
SET GPA = 2.3
WHERE student_ID = 9928;
UPDATE Students
SET GPA = 2.4
WHERE student_ID = 9929;
UPDATE Students
SET GPA = 2.5
WHERE student_ID = 9930;
-- Average GPA per Department
SELECT D.departmentName,
	AVG(S.GPA) AS AverageGPA
FROM Students AS S
	JOIN Departments AS D ON S.inDepartment = D.department_ID
...
FROM Students AS S
	LEFT JOIN Enrollment AS E ON S.student_ID = E.enrolledStudent
	LEFT JOIN Courses AS C ON E.enrolledInCourse = C.course_ID
	LEFT JOIN Professors AS P ON C.instructor = P.professor_ID;
...
FROM Students AS S
	JOIN Departments AS D ON S.inDepartment = D.department_ID
	JOIN DepartmentAverageGPAs AS DAG ON S.inDepartment = DAG.inDepartment
WHERE S.GPA > DAG.AverageDepartmentGPA;